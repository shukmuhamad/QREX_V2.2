                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method ="post" id="InspectionForm">
                                        ...
                                        <div class="form-group">
                                            <?php 
                                            $query = $connect->prepare("SELECT InspectionPlanKey, InspectionPlanName FROM M_InspectionPlan");
                                            $query->execute();
                                            $fetch = $query->fetchAll(PDO::FETCH_ASSOC);
                                            ?>
                            ...
                            Inspection Record
                                ...
                                <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <td><input class="form-control is-valid digit" name="sample_size" id="sample_size" placeholder="0" type="number" min='0' max='500'></td>
                                        </div>
          ...
          <div class="modal-header">
            ...
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
                ...
                <!-- /.panel-heading -->            
                <center><button type="submit" name="submit" form="InspectionForm" class="btn btn-primary">SAVE</button></center></br>                   
