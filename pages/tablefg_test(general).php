    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="tablefg_test(general).php"><i class="fa fa-table fa-fw"></i> FG Table Filter</a>
                        </li>

                        <li>
                            <a href="tablesfg_test(general).php"><i class="fa fa-table fa-fw"></i> SFG Table Filter</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        if (isset($_POST['search'])) {
           ...
           // $keyword2=$_POST['keyword2'];
            ...
            InspectionUserID,
            VerifierID  FROM View_all_FG WHERE PlantName = '$keyword1'");
            $query->execute();
            while ($row=$query->fetch()) {?>
<tr>

            <td><center><a class = "btn btn-success" href = "formqrex_viewFG(general).php?LotIDKey=<?php echo $row['LotIDKey']?>" target="_blank"><i class = "glyphicon glyphicon-show"></i> VIEW</a></center></td>
            ...
            <td class="text-center"><?php echo date('d/m/Y',strtotime($row['ProductionDate']))?></td>    
            <td class="text-center"><?php echo $row['SONumber']?></td>
            ...
            <td class="text-center"><?php echo $row['PalletNumber']?></td>
