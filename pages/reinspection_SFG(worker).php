...
<!----------------------------------------------------------INSPECTION RECORD----------------------------------------------->
        ...
        <div class="modal-content">
          ...
          <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                        ...
                                        <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount" name="STNs" placeholder="0"></td>
                                        
                                        <th scope="col" class="info">SLDs:</th>
                                        <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount" name="SLDs" placeholder="0"></td>
                                        
                                        <th scope="col" class="info">Ls:</th>
                                        <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount" name="Ls" placeholder="0"></td>
                                        </tr>
                                 </table>
          ...
          <div class="modal-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount2" name="GF" placeholder="0"></td>
                                    </tr>       
                                </table>
          ...
          <div class="modal-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount3" name="MS_critical" placeholder="0"></td>
                                    </tr>

                                    <tr>
                                        <th scope="col" class="info">PFK:</th>
                                        <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount3" name="PFK" placeholder="0"></td>
                                ...
                                <table class="table table-bordered" id="dataTable">
                                    <tr>
                                        ...
                                        <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount3" name="GSH" placeholder="0"></td>
          ...
          <div class="modal-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount4" name="LH" placeholder="0"></td>

                                            <th scope="col" class="info">MH:</th>
                                            <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount4" name="MH" placeholder="0"></td>
                                        </tr>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                               ...
                               <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                        ...
                                        <tr>
                                            <th scope="col" class="info">LH:</th>
                                            <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount5" name="LH_2" placeholder="0"></td>

                                            <th scope="col" class="info">MH:</th>
                                            <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount5" name="MH_2" placeholder="0"></td>
                                        </tr>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                                 ...
                                 <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                        ...
                                        <tr>
                                            <th scope="col" class="info">LH:</th>
                                            <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount6" name="LH_3" placeholder="0"></td>

                                            <th scope="col" class="info">MH:</th>
                                            <td><input onkeypress="return isNumberKey(event)" class="form-control input-sm text-right amount6" name="MH_3" placeholder="0"></td>
                                        </tr>
                                 </table>
                                    </div>
                    ...
                    <div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                     <div class="form-group">  
                                     Verify By: <input class="form-control" name="verify_by"  value="<?php echo $get['VerifierID'];?>" readonly>
                                     </div>
                                       
                                     <div class="form-group">   
                                     <?php $VerifyDate = date("Y-m-d\TH:i:s", strtotime($get['VerifiedDate'])); ?>
                                     Date: <br> <input class="form-control" type="datetime-local" name="date_verify" value="<?php echo $VerifyDate;?>"  readonly>
                                     </div> 
                            </div>
                        </div>
                    </div>
...
//-------------------------------------------------- OTHER TESTING & PHYSICAL DIMENSION TEST --------------------------------------------//
            ...
            echo"<script>location.replace('page(worker).php');</script>"; 
